...
{
	u8 temp;
	if(angle<-40||angle>40 || voltage<9.6 || Stop_Flag==1)//电池电压低于10V关闭电机 || voltage<9.6V   The battery voltage is lower than 10V and the motor is turned off || voltage<9.6V
